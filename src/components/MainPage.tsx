...
import OpeningBingoSelector from './OpeningBingoSelector';
import SubsequentTurnSelector from './SubsequentTurnSelector';
								...
								{showHowItWorks && (
									<div className="absolute top-full mt-2 left-1/2 transform -translate-x-1/2 w-80 bg-white border border-gray-300 rounded-lg shadow-lg p-4 z-20">
										<ul className="text-sm text-gray-700 list-disc list-inside space-y-1 text-left">
											<li>
												A Perfect Scrabble Game is one
												in which every turn is a bingo!
											</li>
											<li>
												Assuming perfect word knowledge
												and very lucky tiles, two
												players can have seven bingos
												each!
											</li>
											<li>
												Turn 1 is a random seven-letter
												bingo.
											</li>
											<li>
												Turns 2-12 are random
												eight-letter words that overlap
												with exactly one existing tile.
											</li>
											<li>
												Turns 13 and 14 allow the use of
												one blank tile only.
											</li>
											<li>
												The list of bingos is culled
												according to the words that are
												constructable with the tiles
												remaining.
											</li>
											<li>
												A Wolfram Language back-end API:
												<ol className="list-decimal list-inside ml-4 mt-1 space-y-1">
													<li>
														Updates the tile bag
													</li>
													<li>Finds viable plays</li>
													<li>
